...
return [
    ...
    'quotations' => [
        ...
        'from_quotation' => 'من عرض سعر :reference',
        'columns' => [
            'reference' => 'رقم عرض السعر',
            'contact' => 'العميل',
        ...
        'sections' => [
            'details' => 'بيانات عرض السعر',
            'items' => 'البنود',
            'notes' => 'ملاحظات وشروط',
        ],
        'fields' => [
            'reference' => 'رقم عرض السعر',
            'description' => 'وصف عرض السعر',
            'contact' => 'اسم العميل',
            'issue_date' => 'تاريخ الإصدار',
            'expiry_date' => 'تاريخ الانتهاء',
        ...
        'actions' => [
            ...
            'approve' => 'حفظ وموافقة',
            'approve_confirm' => 'الموافقة تثبّت عرض السعر ولا تؤثر على الحسابات أو التقارير — لا يُرحَّل أي قيد. الترحيل يحدث فقط عند اعتماد الفاتورة الناتجة عن التحويل.',
            'approved' => 'تمت الموافقة على عرض السعر.',
            'convert' => 'تحويل لفاتورة',
            'convert_confirm' => 'سيتم إنشاء مسودة فاتورة من هذا العرض ويصبح العرض «تم الفوترة». تُحتسب الضرائب بنسب تاريخ الفاتورة.',
            'convert_expired_warning' => 'انتهت صلاحية هذا العرض بتاريخ :date. يمكنك المتابعة، وستُنشأ الفاتورة بمسودة قابلة للمراجعة.',
            'converted' => 'تم إنشاء مسودة الفاتورة :reference.',
            'cancel' => 'إلغاء',
            'cancel_confirm' => 'سيصبح عرض السعر ملغيًا ولا يمكن التراجع عن الإلغاء.',
            'cancelled' => 'تم إلغاء عرض السعر.',
        ],
        'hints' => [
            'expiry_date' => 'صلاحية العرض — بعد هذا التاريخ يُعد العرض منتهيًا.',
        ],
        'errors' => [
            'no_items' => 'لا يمكن الموافقة على عرض سعر بلا بنود.',
            'already_approved' => 'عرض السعر :reference موافق عليه بالفعل.',
            'not_draft' => 'لا يمكن تعديل عرض سعر بعد الموافقة عليه.',
            'inactive_contact' => 'العميل :contact غير نشط.',
            'expiry_before_issue' => 'تاريخ الانتهاء لا يمكن أن يسبق تاريخ الإصدار.',
            'totals_do_not_reconcile' => 'إجماليات عرض السعر :reference لا تتطابق مع بنوده.',
            'not_approved' => 'لا يمكن تحويل عرض السعر :reference — التحويل متاح للعروض الموافق عليها فقط.',
            'already_invoiced' => 'عرض السعر :reference سبق تحويله إلى الفاتورة :invoice.',
            'tax_no_longer_available' => 'الضريبة «:tax» المستخدمة في هذا العرض لم تعد متاحة. حدّث بنود العرض قبل التحويل.',
            'cannot_cancel' => 'لا يمكن إلغاء عرض السعر :reference في حالته الحالية.',
        ],
    ],
    ...
    'products' => [
        ...
        'hints' => [
            'expense_account' => 'الحساب الذي تُقيَّد عليه مشتريات هذا المنتج. الافتراضي تكلفة البضاعة المباعة.',
    ...
    'customer_aging' => [
        ...
        'contact' => 'اتصال',
        'code' => 'الرقم المرجعي للجهة',
        'totals' => 'المجموع',
        'empty' => 'لا توجد بيانات في الفترة المختارة.',
        'foreign_warning' => ':count مستند بعملة أجنبية مُدرج بقيمته الاسمية دون تحويل.',
        'unapplied_notes' => 'إشعارات دائنة غير مخصصة على فواتير',
        'advances' => 'دفعات مقدمة من العملاء غير مخصصة',
    ],

    'quotation_aging' => [
        'title' => 'أعمار عروض الأسعار',
        'as_of' => 'تاريخ التقرير',
        'compare_with' => 'مقارنة بـ',
        'no_comparison' => 'بدون مقارنة',
        'periods' => 'عدد فترات المقارنة',
    ...
    'customer_balances' => [
        'title' => 'ملخص مستحقات العملاء',
        'as_of' => 'تاريخ التقرير',
        'contact' => 'اسم العميل',
        'code' => 'الرقم المرجعي للجهة',
        'open_invoices' => 'المبالغ المستحقة على الفواتير',
        'unapplied_notes' => 'إشعارات دائنة لم تستخدم',
        'unused_vouchers' => 'مبالغ سندات قبض لم تستخدم',
        'net' => 'صافي المبلغ المستحق',
        'totals' => 'المجموع',
        'empty' => 'لا توجد بيانات في التاريخ المختار.',
    ],
