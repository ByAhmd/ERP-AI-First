...
return [
    ...
    'supplier_aging' => [
        ...
        'as_of' => 'تاريخ التقرير',
        'compare_with' => 'مقارنة بـ',
        'no_comparison' => 'بدون مقارنة',
        'periods' => 'عدد فترات المقارنة',
        'units' => [
            'year' => 'سنة ماضية',
            'quarter' => 'ربع سابق',
            'month' => 'شهر ماضي',
        ...
        'contact' => 'اسم المورد',
        'code' => 'الرقم المرجعي للمورد',
        'totals' => 'المجموع',
        'empty' => 'لا توجد بيانات في الفترة المختارة.',
        'foreign_warning' => ':count مستند بعملة أجنبية مُدرج بقيمته الاسمية دون تحويل.',
        'unapplied_notes' => 'إشعارات مدينة غير مخصصة على فواتير',
        'advances' => 'دفعات مقدمة للموردين غير مخصصة',
    ],

    'order_aging' => [
        'title' => 'أعمار أوامر الشراء',
        'as_of' => 'تاريخ التقرير',
        'compare_with' => 'مقارنة بـ',
        'no_comparison' => 'بدون مقارنة',
        'periods' => 'عدد فترات المقارنة',
