...
return [
    ...
    'transfers' => [
        'label' => 'نقل مخزون',
        'plural_label' => 'نقل المخزون',
        'nav_label' => 'نقل المخزون',
        'columns' => [
            'reference' => 'المرجع',
            'from_branch' => 'الموقع المُرسل',
            'to_branch' => 'الموقع المُرسل إليه',
            'date' => 'التاريخ',
            'status' => 'الحالة',
        ],
        'sections' => [
            'details' => 'بيانات النقل',
            'items' => 'البنود',
        ],
        'fields' => [
            'reference' => 'المرجع',
        ...
        'actions' => [
            'save_draft' => 'حفظ كمسودة',
            'approve' => 'إرسال واستقبال',
            'approve_confirm' => 'ستنتقل الكميات من الموقع المُرسل إلى الموقع المُرسل إليه فورًا، ولا يمكن تعديل النقل بعدها — التصحيح بنقل معاكس.',
            'approved' => 'تم النقل.',
        ],
        'errors' => [
            'no_items' => 'لا يمكن اعتماد نقل بلا بنود.',
            'already_approved' => 'النقل :reference معتمد بالفعل.',
            'not_draft' => 'لا يمكن تعديل نقل بعد اعتماده.',
            'same_branch' => 'الموقعان متطابقان — اختر موقعًا مختلفًا للاستقبال.',
            'zero_line' => 'البند :line بلا كمية.',
        ],
    ],
