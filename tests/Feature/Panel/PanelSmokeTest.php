...
final class PanelSmokeTest extends TestCase
{
    ...
    public function the_navigation_lists_every_section_the_administrator_may_reach(): void
    {
        ...
        $response->assertSee(__('purchases.simple_invoices.nav_label'), escape: false);
        ...
        $response->assertSee(__('sales.customer_balances.title'), escape: false);
        $response->assertSee(__('purchases.supplier_balances.title'), escape: false);
